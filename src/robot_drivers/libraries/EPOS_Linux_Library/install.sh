...
# EPOS Command Library 6.4.1.0 installation script
...
echo '---------------------------------------------------------'
echo 'EPOS Command Library 6.4.1.0 installation started'
echo '---------------------------------------------------------'

#remove previous installation
printf ' - Remove existing installation'
rm -rf '/opt/EposCmdLib_6.4.1.0' > /dev/null
check_result

#copy examples, include and misc files
printf ' - Install library into directory: /opt/EposCmdLib_6.4.1.0'
mkdir '/opt/EposCmdLib_6.4.1.0' > /dev/null
mkdir '/opt/EposCmdLib_6.4.1.0/lib' > /dev/null

cp -rf ./include '/opt/EposCmdLib_6.4.1.0' > /dev/null
architecture=$(uname -m)
case $architecture in
	armv7l)
		cp -rf ./lib/armv7hf '/opt/EposCmdLib_6.4.1.0/lib' > /dev/null
		;;
	 x86|i386|i486|i586|i686)
		cp -rf ./lib/x86 '/opt/EposCmdLib_6.4.1.0/lib' > /dev/null
		;;
	 x86_64)
		cp -rf ./lib/x86_64 '/opt/EposCmdLib_6.4.1.0/lib' > /dev/null
		;;
esac
check_result

#copy examples, include and misc files
printf ' - Install examples into directory: /opt/EposCmdLib_6.4.1.0'
if [ ! -d "/opt/EposCmdLib_6.4.1.0" ]; then
mkdir '/opt/EposCmdLib_6.4.1.0' > /dev/null
fi

cp -rf ./examples '/opt/EposCmdLib_6.4.1.0' > /dev/null
cp -rf ./misc '/opt/EposCmdLib_6.4.1.0' > /dev/null
find "/opt/EposCmdLib_6.4.1.0/examples" -type d -exec chmod 777 {} \;
find "/opt/EposCmdLib_6.4.1.0/examples" -type f -exec chmod 666 {} \;
check_result
...
echo '---------------------------------------------------------'
echo 'EPOS Command Library 6.4.1.0 installed'
echo '---------------------------------------------------------'
}
function uninstall {

echo '---------------------------------------------------------'
echo 'EPOS Command Library 6.4.1.0 deinstallation started'
echo '---------------------------------------------------------'
...
echo '---------------------------------------------------------'
echo 'EPOS Command Library 6.4.1.0 uninstalled'
echo '---------------------------------------------------------'
}
