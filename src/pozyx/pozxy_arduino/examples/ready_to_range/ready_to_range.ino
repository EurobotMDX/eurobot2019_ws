...
uint16_t destination_id = 0x6778;     // the network id of the other pozyx device: fill in the network id of the other device
signed int range_step_mm = 10;      // every 1000mm in range, one LED less will be giving light.
