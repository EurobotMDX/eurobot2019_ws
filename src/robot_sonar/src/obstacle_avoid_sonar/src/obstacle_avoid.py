...
class ObstAvoid():
    def __init__(self):
        ...
        self.sub_center = rospy.Subscriber("/left_ultrasonic_data", Range, self.update_range)
        self.sub_left = rospy.Subscriber("/front_ultrasonic_data", Range, self.update_range)
        self.sub_right = rospy.Subscriber("/right_ultrasonic_data", Range, self.update_range)
